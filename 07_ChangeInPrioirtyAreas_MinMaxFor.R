...
#note this code trys to look at min and max inpacts. Assumes that initially forest areas are 
# primarily forest, so if forest in colrow then will first be forest. 
...
PriA_ForMinMax_IDCbrazil$HaPriAPriFor2010<-ifelse(
...
write.csv(PriAFMM_IDCbrazil, file="PriAFMM_IDCbrazil.csv", 
...
#calculating inital forest area
PriA_ForMinMax_FC$HaPriAPriFor2010<-ifelse(
...
PriAFMM_FC<-PriA_ForMinMax_FC[c("colrow","HaPriArea","HaPriAPriFor2010","PriForEven10_50",
                                      "PriForMax10_50","PriForMin10_50" )]
write.csv(PriAFMM_FC, file="PriAFMM_FC.csv", 
          row.names=FALSE, quote=FALSE)
...
#calculating inital forest area
PriA_ForMinMax_FCnoSFA$HaPriAPriFor2010<-ifelse(
...
PriAFMM_FCnoSFA<-PriA_ForMinMax_FCnoSFA[c("colrow","HaPriArea","HaPriAPriFor2010","PriForEven10_50",
                                "PriForMax10_50","PriForMin10_50" )]
write.csv(PriAFMM_FCnoSFA, file="PriAFMM_FCnoSFA.csv", 
          row.names=FALSE, quote=FALSE)
...
#calculating inital forest area
PriA_ForMinMax_FCnoCRA$HaPriAPriFor2010<-ifelse(
...
PriAFMM_FCnoCRA<-PriA_ForMinMax_FCnoCRA[c("colrow","HaPriArea","HaPriAPriFor2010","PriForEven10_50",
                                        "PriForMax10_50","PriForMin10_50" )]
write.csv(PriAFMM_FCnoCRA, file="PriAFMM_FCnoCRA.csv", 
          row.names=FALSE, quote=FALSE)
...
#calculating inital forest area
PriA_ForMinMax_FCnoCRAnoSFA$HaPriAPriFor2010<-ifelse(
...
PriAFMM_FCnoCRAnoSFA<-PriA_ForMinMax_FCnoCRAnoSFA[c("colrow","HaPriArea","HaPriAPriFor2010","PriForEven10_50",
                                        "PriForMax10_50","PriForMin10_50" )]
write.csv(PriAFMM_FCnoCRAnoSFA, file="PriAFMM_FCnoCRAnoSFA.csv", 
          row.names=FALSE, quote=FALSE)
#######summary####
...
setwd(outputpath)
write.csv(PriAForMinMax_allB, file="PriAForMinMax_allB.csv", 
          row.names=FALSE, quote=FALSE)
write.csv(PriAFMM__all, file="PriAForMinMax_all.csv")
names(PriAFMM__all)          